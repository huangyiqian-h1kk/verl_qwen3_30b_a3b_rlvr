#!/bin/bash
# Reasoning Gym 16K: validate both original-v3 partitions and aggregate on the login node.
...
echo "[PASS] experiment reasoning_gym_16k two-job entropy curve complete: $OUT_ROOT"
